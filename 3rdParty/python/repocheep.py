...
config_reader("/mnt/tech/repositories/apt/baseblack-lucid/conf/distributions")
...
class reprepro(object):
    ...
    def _exec(self, cmd):
        ...
        if p.returncode:
            raise RepositoryException('reprepro experienced an error', err)
...
class Repository(object):
    ...
    def remove(self, codename, package_name):
        try:
            reprepro(self.options).action('remove', codename, package_name)
            return True
